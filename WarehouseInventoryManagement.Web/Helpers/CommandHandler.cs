...
using WarehouseInventoryManagement.Web.Resources;
...
namespace WarehouseInventoryManagement.Web.Helpers
{
    ...
    public static class CommandHandler
    {
        ...
        public static TResponse ExecuteCommand<TRequest, TResponse>(this ICommand<TRequest, TResponse> command,
                                                                    TRequest request)
        {
            try
            {
        ...
        /// <param name="command">The command.</param>
        /// <param name="request">The request.</param>
        private static void HandleValidationException(MessagePropagationException ex, ICommandBase command,
                                                      object request = null)
        {
        ...
        /// <param name="command">The command.</param>
        /// <param name="request">The request.</param>
        private static void HandleConcurrentDataException(ConcurrentDataException ex, ICommandBase command,
                                                          object request = null)
        {
            Log.Trace(FormatCommandExceptionMessage(command, request), ex);
